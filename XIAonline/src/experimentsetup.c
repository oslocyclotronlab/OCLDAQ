...
DetectorInfo_t pDetector[] =
{
    ...
    {40, f250MHz, labr, 8, 0},
    {41, f250MHz, labr, 9, 0},
    {42, f250MHz, labr, 10, 0},
    {43, f250MHz, labr, 11, 0},
    {44, f250MHz, labr, 12, 0},
    {45, f250MHz, labr, 13, 0},
    {46, f250MHz, labr, 14, 0},
    {47, f250MHz, labr, 15, 0},
    {48, f250MHz, labr, 16, 0},
    {49, f250MHz, labr, 17, 0},
    {50, f250MHz, labr, 18, 0},
    {51, f250MHz, labr, 19, 0},
    {52, f250MHz, labr, 20, 0},
    {53, f250MHz, labr, 21, 0},
    {54, f250MHz, labr, 22, 0},
    {55, f250MHz, labr, 23, 0},
    {56, f250MHz, labr, 24, 0},
    {57, f250MHz, labr, 25, 0},
    {58, f250MHz, labr, 26, 0},
    {59, f250MHz, labr, 27, 0},
    {60, f250MHz, labr, 28, 0},
    {61, f250MHz, labr, 29, 0},
    {62, f250MHz, labr, 30, 0},
    {63, f250MHz, labr, 31, 0},
    ...
    {128, f500MHz, eGuard, 0, 0},
    {129, f500MHz, eDet, 0, 0},
    {130, f500MHz, eGuard, 1, 0},
    {131, f500MHz, eDet, 1, 0},
    {132, f500MHz, eGuard, 2, 0},
    {133, f500MHz, eDet, 2, 0},
    {134, f500MHz, eGuard, 3, 0},
    {135, f500MHz, eDet, 3, 0},
    {136, f500MHz, eGuard, 4, 0},
    {137, f500MHz, eDet, 4, 0},
    {138, f500MHz, eGuard, 5, 0},
    {139, f500MHz, eDet, 5, 0},
    {140, f500MHz, eGuard, 6, 0},
    {141, f500MHz, eDet, 6, 0},
    {142, f500MHz, eGuard, 7, 0},
    {143, f500MHz, eDet, 7, 0},
