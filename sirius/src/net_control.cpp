...
static void binary_server_cb_disconnected(binary_channel* bc, unsigned int s, unsigned int us, const unsigned char* data, size_t size, void* user_data)
{
...
void binary_channel::send_frame(unsigned int s, unsigned int us, const void* data, size_t size)
{
    ...
    memcpy(outbuf.data() + header_size, data, size);
