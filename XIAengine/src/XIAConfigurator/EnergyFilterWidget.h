...
#ifndef XIACONFIGURATOR_ENERGYFILTERWIDGET_H
#define XIACONFIGURATOR_ENERGYFILTERWIDGET_H
...
class EnergyFilter : public QGroupBox
{
    Q_OBJECT
private:
    XIAInterface *interface;
public:
    EnergyFilter(XIAInterface *interface, QWidget *parent = nullptr);
...
#endif //XIACONFIGURATOR_ENERGYFILTERWIDGET_H
