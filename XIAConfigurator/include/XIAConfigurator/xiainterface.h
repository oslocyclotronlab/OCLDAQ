...
public:
    ...
    virtual void SetChnParam(const size_t &module, const size_t &channel, const char *ChanParName,
                             const ChanPar_t &parameter) = 0;
...
public:
    explicit XIAInterfaceMock(const size_t &num_modules = 4);
