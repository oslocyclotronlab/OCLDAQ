#ifndef TRIGCONFIG_H_
#define TRIGCONFIG_H_
#include "TGFrame.h"
...
class TrigConfig:public TGTransientFrame
{
public:
  TrigConfig (const TGWindow * p, const TGWindow * main,int NumModules=13);
    virtual ~ TrigConfig ();
private:
    int numModules;
  ...
  TGCheckButton *ckBtn[17], *ckBtn_1[17], *ckBtn_2[17], *ckBtn_3[17],
    ...
    *ckBtn_14[17], *ckBtn_15[17], *ckBtn_16[17], *ckBtn_17[17], *ckBtn_18[17],
    *ckBtn_19[17], *ckBtn_20[17], *ckBtn_21[17], *ckBtn_22[17], *ckBtn_23[17];
